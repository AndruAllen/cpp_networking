...
class FIFOrc: public RequestChannel{
...
public:
	FIFOrc(const string _name, const Side _side);
	~FIFOrc();
...
class MQrc: public RequestChannel{
public:
	MQrc(const string _name, const Side _side) : RequestChannel(_name, _side) {

	}
	~MQrc(){}

	string cread(){ // temp check
		return side_name;
	}

	int cwrite(string _msg){ // temp check
		return (int) (_msg == "fun");
	}
};

class SHMrc: public RequestChannel{
public:
	SHMrc(const string _name, const Side _side) : RequestChannel(_name, _side) {
